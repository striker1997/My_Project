...
<body>
    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins" style="background-image: url('<?php echo base_url()?>assets/signup/images/aqua-d9b59c89.png');" >
        <div class="wrapper wrapper--w680">
            <div class="card card-4"  style="background-image: url('<?php echo base_url()?>assets/signup/images/aqua-d9b59c89.png');">
               ...
               <?php }?>
                <div class="card-body">
                   ...
                   <h1 style='color:black' style='font:italic'>Registering as Admin</h1>
                    
                           
                      <?php form_open('Welcome/validate');?>
                    <form method="POST"> 
